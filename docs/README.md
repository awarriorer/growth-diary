...
你也可以点击[这里](https://awarriorer.github.io/growth-diary/)以获得更好的阅读体验。
...
* [EventLoop](./js-advanced/eventLoop.md)
...
* Vue(v2.5.16) 源码分析
  ...
  * [虚拟dom是什么？虚拟dom如何比对差异的](./vue-analysis/vNode.md)
  * [$nextTick是怎么实现的？](./vue-analysis/nextTick.md)
  * 生命周期中的各个环节都做了什么
  * components是怎么实现的？
  * 指令是怎么实现的？
  * user 插件的原理
